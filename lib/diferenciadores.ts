...
export const ENTREGA_DIAS = 3
export const ENTREGA = 'entrega en 3 días hábiles'
...
- *Cremación Individual*: certificado de cremación digital, ánfora de greda marmoleada, botellita con mechón de pelo, etiqueta de madera con el nombre, retiro en domicilio o clínica y entrega en 3 días hábiles.
