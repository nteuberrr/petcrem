...
- NUNCA inventes precios, promociones ni datos. Plazos: SOLO los oficiales (entrega ${ENTREGA_TXT}${expressDisponible() ? ', o 48 horas hábiles con el Servicio Express opcional' : ''}; retiro habitualmente en menos de 3 horas). Ningún otro plazo.
