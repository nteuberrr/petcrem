...
export async function generarInformeCorporativoPdf(): Promise<Buffer> {
  ...
  defItem('Cremación Individual', `Certificado de cremación digital, ánfora de greda marmoleada, botellita con mechón de pelo, etiqueta de madera con el nombre, retiro en domicilio o clínica y entrega ${ENTREGA_TXT}.`)
  ...
  bullets([
    `La entrega de cenizas y certificado se realiza ${ENTREGA_TXT}.`,
  ...
  defItem('5. Entrega', `Entregamos las cenizas junto al certificado digital de cremación ${ENTREGA_TXT}. Disponemos de video del ingreso de la mascota al horno para quien lo solicite.`)
  ...
  bullets([
    ...
    `Entrega garantizada ${ENTREGA_TXT}.`,
