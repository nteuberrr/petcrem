 ...
 *
 * Mira SOLO la hora de la eutanasia: el recargo se cobra cuando el servicio pasa
 * de las 18:00, parte por parte. Si la eutanasia queda dentro de horario y el
 * retiro se pasa, el recargo existe pero lo lleva la CREMACIÓN — ver
 * `cremacionLlevaRecargoFueraHorario` en lib/adicionales-auto.
 */
