...
const TOOL_COTIZAR_CREMACION: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      eutanasia_fuera_horario: { type: 'boolean', description: 'true SOLO si esta cremación va junto a una eutanasia que ya lleva el recargo fuera de horario (para no cobrarlo dos veces).' },
    },
    required: ['peso'],
  },
}
