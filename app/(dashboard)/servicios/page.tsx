    ...
    >
      ...
      {!incluyeCremacion(c) && (
        <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-gray-600 bg-gray-100 border border-gray-300 px-1.5 py-0.5 rounded mb-0.5">
          <Ban className="w-3 h-3 shrink-0 inline-block align-[-2px]" aria-hidden="true" /> Sin cremación
        </span>
      )}
      ...
      {c.vet_nombre_asignado && (
        <p className="text-xs text-gray-700 mt-1 flex items-center gap-1">
          <Stethoscope className="w-3.5 h-3.5 text-gray-400 shrink-0" aria-hidden="true" />
      ...
      <p className="text-xs text-gray-600 mt-1 flex items-center gap-1">
        <CalendarDays className="w-3.5 h-3.5 text-gray-400 shrink-0" aria-hidden="true" />
