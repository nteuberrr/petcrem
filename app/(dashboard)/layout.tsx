  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 min-w-0 max-w-full md:ml-60 p-4 pt-16 md:p-8 bg-slate-200 min-h-screen">
        {/* Contenido alineado a la IZQUIERDA y a todo el ancho disponible (sin
            centrarlo ni dejar gris a los costados). Las páginas con su propio
            max-w menor siguen mandando adentro. */}
