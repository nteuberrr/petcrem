...
import { getSheetData, appendRow, getNextId, deleteRow, ensureColumn, ensureSheet, updateRow } from '@/lib/google-sheets'
...
async function ensure() {
  ...
  for (const col of COLS) await ensureColumn(HOJA, col)
}
